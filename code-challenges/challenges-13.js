...
const objectCounter = (obj) => {
    ...
    let counter = 0;
    obj.reduce(myfun, 0);
    function myfun(finalVal, currentValue) {
        counter++;
    }
    return counter;
}
...
const stringReverse = (str) => {
    // write your code here
    let thestringArr = str.split(" ");
    let reversedStringArr = thestringArr.reverse();
    let reveresedString = reversedStringArr.reduce(myfun);
    function myfun(final, item, index, arr) {
        return final = final+" "+item
    }
